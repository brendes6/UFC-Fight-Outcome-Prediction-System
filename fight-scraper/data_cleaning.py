...
def get_data_points(df):
    ...
    # Do not impute with a full-history mean.  That leaks future distribution
    # information and is not part of the canonical feature contract.
...
def clean_up_data(df):
    ...
    # print(df["RedAvgSigStrLanded"])
    # print(df["BlueAvgSigStrLanded"])
